...
public class OffreService {
    ...
    public Page<Offre> filterOffres(String secteur, String contrat, String localisation,String teletravail, Double salaireMin, Double salaireMax,String experience, Pageable pageable) {
        int offset = pageable.getPageNumber() * pageable.getPageSize();
        List<Offre> offres = offreMapper.filterOffres(secteur, contrat, localisation,teletravail,experience ,salaireMin,salaireMax, pageable.getPageSize(), offset);
        int total = offreMapper.countFiltered(secteur, contrat, localisation,experience, salaireMin,salaireMax);
        return new PageImpl<>(offres, pageable, total);
    }
}
